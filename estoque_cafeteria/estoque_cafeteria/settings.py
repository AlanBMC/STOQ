"""
Django settings for estoque_cafeteria project.
...
ROOT_URLCONF = 'estoque_cafeteria.urls'
...
WSGI_APPLICATION = 'estoque_cafeteria.wsgi.application'
...
STATIC_URL = '/static/'  # URL para acessar arquivos estáticos (ex: /static/css/style.css)
